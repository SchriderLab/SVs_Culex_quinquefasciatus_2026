...
# 2.2. Add ".1" back to chromosome names after running Jasmine & before splitting samples (needed for Sniffles genotyping/downstream analysis)
awk 'BEGIN{FS=OFS="\t"}
/^#/ {print; next}
{
    $1 = $1 ".1"
